                      ...
                      _In_       int       nCmdShow)
{
        ...
        LoadStringW(hInstance, IDC_KLUTZMINIAPP, szWindowClass, MAX_PATH);
        // MyRegisterClass(hInstance);  // By executive decision of Dave!!!

        HACCEL hAccelTable = LoadAccelerators(hInstance, MAKEINTRESOURCE(IDC_KLUTZMINIAPP));
        ...
        wcex.hIcon           = LoadIcon(hInstance, MAKEINTRESOURCE(IDI_KLUTZMINIAPP));
        wcex.hCursor         = LoadCursor(nullptr, IDC_ARROW);
        wcex.hbrBackground   = (HBRUSH)(COLOR_WINDOW + 1);
        wcex.lpszMenuName    = MAKEINTRESOURCE(IDC_KLUTZMINIAPP);
